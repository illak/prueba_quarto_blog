...
author: "Illak Zapata"
date: "2024-05-10"
categories: [análisis, R, código, visualización]
image: ""
language: 
...
Cargamos las librerias necesarias, en este caso usaremos solamente las siguientes 3
...
educativos de la provincia de Córdoba, procesados y disponibles para
descargar en `.csv`:
...
Agregamos un tema predefinido, en este caso el famoso [*FiveThirtyEight*](http://fivethirtyeight.com/).
...
Agregamos los *spanners* o agrupaciones de columnas
...
Agregamos un "mapa de calor" para las columnas de totales
